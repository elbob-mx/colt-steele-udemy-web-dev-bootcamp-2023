const subreddits = ["cringe", "mexico", "mgs", "rdr2", "cp2077", "tacos", "cats", "rodney mullen"];
...
console.log(
    `*** Our Weekly Pick: reddit.com/r/${subreddits[Math.floor(Math.random() * subreddits.length)]}`
);
