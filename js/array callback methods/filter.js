...
const userNames = (array) => array.filter((user) => user.length < 10);
console.log(userNames(array));
/* the const takes the array as a parameter; defines each element as a 'user'; measures each 'user' length; then filters them by the ones that are less than 10 characters; then return those in a new array called 'userNames' */
